...
// Source: github.com/weaveworks-liquidmetal/flintlock/core/ports (interfaces: MicroVMService,MicroVMRepository,EventService,IDService,ImageService,ReconcileMicroVMsUseCase,NetworkService,MicroVMCommandUseCases,MicroVMQueryUseCases,DiskService)
...
import (
	...
	models "github.com/weaveworks-liquidmetal/flintlock/core/models"
	ports "github.com/weaveworks-liquidmetal/flintlock/core/ports"
)
...
// Create mocks base method.
func (m *MockDiskService) Create(arg0 context.Context, arg1 ports.DiskCreateInput) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Create", arg0, arg1)
	ret0, _ := ret[0].(error)
	return ret0
...
// Create indicates an expected call of Create.
func (mr *MockDiskServiceMockRecorder) Create(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Create", reflect.TypeOf((*MockDiskService)(nil).Create), arg0, arg1)
}
