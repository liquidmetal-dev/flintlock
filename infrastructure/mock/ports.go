...
// Source: github.com/liquidmetal-dev/flintlock/core/ports (interfaces: MicroVMService,MicroVMRepository,EventService,IDService,ImageService,ReconcileMicroVMsUseCase,NetworkService,MicroVMCommandUseCases,MicroVMQueryUseCases,SnapshotPackager)
...
func (m *MockMicroVMService) Snapshot(arg0 context.Context, arg1 ports.SnapshotInput) (*ports.SnapshotResult, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Snapshot", arg0, arg1)
	ret0, _ := ret[0].(*ports.SnapshotResult)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// Snapshot indicates an expected call of Snapshot.
func (mr *MockMicroVMServiceMockRecorder) Snapshot(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Snapshot", reflect.TypeOf((*MockMicroVMService)(nil).Snapshot), arg0, arg1)
}
...
// SnapshotMicroVM mocks base method.
func (m *MockMicroVMCommandUseCases) SnapshotMicroVM(arg0 context.Context, arg1, arg2 string) (*ports.SnapshotImage, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SnapshotMicroVM", arg0, arg1, arg2)
	ret0, _ := ret[0].(*ports.SnapshotImage)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// SnapshotMicroVM indicates an expected call of SnapshotMicroVM.
func (mr *MockMicroVMCommandUseCasesMockRecorder) SnapshotMicroVM(arg0, arg1, arg2 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SnapshotMicroVM", reflect.TypeOf((*MockMicroVMCommandUseCases)(nil).SnapshotMicroVM), arg0, arg1, arg2)
}
...
// MockSnapshotPackager is a mock of SnapshotPackager interface.
type MockSnapshotPackager struct {
	ctrl     *gomock.Controller
	recorder *MockSnapshotPackagerMockRecorder
}

// MockSnapshotPackagerMockRecorder is the mock recorder for MockSnapshotPackager.
type MockSnapshotPackagerMockRecorder struct {
	mock *MockSnapshotPackager
}

// NewMockSnapshotPackager creates a new mock instance.
func NewMockSnapshotPackager(ctrl *gomock.Controller) *MockSnapshotPackager {
	mock := &MockSnapshotPackager{ctrl: ctrl}
	mock.recorder = &MockSnapshotPackagerMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockSnapshotPackager) EXPECT() *MockSnapshotPackagerMockRecorder {
	return m.recorder
}

// Build mocks base method.
func (m *MockSnapshotPackager) Build(arg0 context.Context, arg1 ports.SnapshotPackageInput) (*ports.SnapshotImage, error) {
	m.ctrl.T.Helper()
...
func (mr *MockSnapshotPackagerMockRecorder) Build(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Build", reflect.TypeOf((*MockSnapshotPackager)(nil).Build), arg0, arg1)
}
