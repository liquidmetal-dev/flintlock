...
//go:generate ../../hack/tools/bin/mockgen -destination ports.go -package mock github.com/liquidmetal-dev/flintlock/core/ports MicroVMService,MicroVMRepository,EventService,IDService,ImageService,ReconcileMicroVMsUseCase,NetworkService,MicroVMCommandUseCases,MicroVMQueryUseCases,SnapshotPackager
