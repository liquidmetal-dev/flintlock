...
// Source: github.com/containerd/containerd/v2/client (interfaces: Image)
...
func (m *MockImage) Unpack(arg0 context.Context, arg1 string, arg2 ...client.UnpackOpt) error {
	m.ctrl.T.Helper()
...
func (m *MockImage) Usage(arg0 context.Context, arg1 ...client.UsageOpt) (int64, error) {
	m.ctrl.T.Helper()
